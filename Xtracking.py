...
#!/usr/bin/python
# << CODE BY MR.X
# << DONT RECODE THIS SHIT MOTHERFUCKER
# << YOU WANT SOME HACK?
...
`\`\/'/'| ,_) _ __   _ _    ___ | |/') (_)  ___     __     
  >  <  | |  ( '__)/'_` ) /'___)| , <  | |/' _ `\ /'_ `\   
 /'/\`\ | |_ | |  ( (_| |( (___ | |\`\ | || ( ) |( (_) |   
(_)  (_)`\__)(_)  `\__,_)`\____)(_) (_)(_)(_) (_)`\__  |   
                                                 ( )_) |   
                                                  \___/'                                                                                                                                                                                                 
          {Wh}</>  C O D E   B Y  M R . X  </>
...
if input_user == '1': #OPSI 1
    ...
    stderr.writelines(f"""{Wh}
        ...
        {Wh}------------------------------------
        {Wh}| {Gr}Xtracking - TRACKER - IP ADDRESS {Wh}|
        {Wh}|       {Gr}@CODE BY MR.X              {Wh}|
        {Wh}------------------------------------
    ...
    stderr.writelines(f"""{Wh}
       ...
       {Wh}--------------------------------------
       {Wh}| {Gr}Xtracking - TRACKER - PHONE NUMBER {Wh}|
       {Wh}|        {Gr}@CODE BY MR.X               {Wh}|
       {Wh}--------------------------------------
   ...
   {Wh}--------------------------------------
   {Wh}|  {Gr}Xtracking - SHOW YOUR IP ADDRESS  {Wh}|
   {Wh}|        {Gr}@CODE BY MR.X               {Wh}|
   {Wh}--------------------------------------
...
""")
   ...
   {Wh}--------------------------------------
   {Wh}|    {Gr}Xtracking - TRACKER USERNAME    {Wh}|
   {Wh}|        {Gr}@CODE BY MR.X               {Wh}|
   {Wh}--------------------------------------
...
""")
    ...
    print(f"\n  {Wh}[{Ye}!{Wh}] {Ye}THANK'S FOR USING TOOL {Ye}XTRACKING !")
else:
